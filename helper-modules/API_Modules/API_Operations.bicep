...
resource service 'Microsoft.ApiManagement/service@2024-06-01-preview' existing = {
  name: apiManagement.name
  resource existing_api 'apis@2024-06-01-preview' existing = {
    name: api.name
  }
}
resource apiOperations 'Microsoft.ApiManagement/service/apis/operations@2024-06-01-preview' = {
  ...
  resource policy 'policies@2024-06-01-preview' = if (operation.?policyXml  != null) {
    name: 'policy'
    properties: {
