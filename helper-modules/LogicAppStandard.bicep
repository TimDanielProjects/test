...
@description('Required. Enable Nodinite logging to send WorkflowRuntime diagnostic logs to Event Hub for Nodinite.')
...
resource nodiniteStorageAccount 'Microsoft.Storage/storageAccounts@2025-01-01' existing = {
