...
resource blobContainer_1 'Microsoft.Storage/storageAccounts/blobServices/containers@2025-01-01' = {
  name: '${storageAccount.name}/default/${nodiniteLogging_blobName}'
  properties: {}
}

resource blobContainer_2 'Microsoft.Storage/storageAccounts/blobServices/containers@2025-01-01' = {
  name: '${storageAccount.name}/default/${nodiniteLogging_FunctionBlobName}'
  properties: {}
}

resource blobContainer_3 'Microsoft.Storage/storageAccounts/blobServices/containers@2025-01-01' = {
